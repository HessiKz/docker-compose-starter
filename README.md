...
> Multi-service compose starter: API + worker + Postgres + Redis + Nginx with Make-driven dev workflow.

**Category:** DevOps  
**Built with:** Docker, Compose, Nginx, Make  
...
👉 https://HessiKz.github.io/docker-compose-starter/
...
git clone https://github.com/HessiKz/docker-compose-starter.git
